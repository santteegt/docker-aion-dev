...
new_sync = root.find('sync')
override_child_text(new_sync, 'show-status', 'show-status', os.environ.get('sync_show_status'))
...
override_child_text(new_consensus, 'cpu-mine-threads', 'cpu-mine-threads', os.environ.get('cpu_mine_threads'))  
...
override_child_text(new_log, 'P2P', 'log_level_p2p', os.environ.get('log_level_p2p'))
